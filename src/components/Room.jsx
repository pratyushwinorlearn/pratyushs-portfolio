...
export default function Room({ playerState, isUIOpen, closeUI, ...props }) {
  ...
  // Brought this back so the right-side screen works again!
      ...
      <RigidBody type="fixed" colliders="trimesh">
        <group {...props} dispose={null}>
          ...
          <mesh 
            ...
            onClick={(e) => {
              e.stopPropagation(); 
              console.log("📍 EXACT SCREEN COORDINATES (x, y, z):", e.point.x.toFixed(3), e.point.y.toFixed(3), e.point.z.toFixed(3));
            }}
          >
          ...
          {/* RESTORED CHANNEL 1: The Isolated Screen */}
          <mesh 
